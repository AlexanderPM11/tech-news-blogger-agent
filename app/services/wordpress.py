...
def obtener_categorias_wordpress() -> str:
    ...
    en formato 'ID - Nombre'. En caso de error, retorna un listado fallback.
    """
    ...
    try:
        ...
        return (
            "25 - _highlights, 24 - _servicesonly, 13 - (P) - Aplicaciones Web, 14 - (P) - Ecommerce, "
            "19 - aaPanel, 5 - Bases de Datos, 18 - Corporativo, 3 - Desarrollo Web, 4 - DevOps y Cloud, "
            "9 - Educación y Tecnología, 16 - Finanzas, 6 - Frameworks y Librerías, 27 - Habilidades, "
            "17 - Inmobiliaria, 21 - Mail, 22 - n8n, 10 - Noticias y Actualizaciones, 12 - projects, "
